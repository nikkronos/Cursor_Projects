...
@rate_limit(max_requests=10, time_window=15.0, block_duration=60.0)
...
@rate_limit(max_requests=15, time_window=10.0, block_duration=60.0)
...
@rate_limit(max_requests=3, time_window=60.0, block_duration=120.0)
